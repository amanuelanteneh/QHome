...
QT_MOC_LITERAL(1, 16, 10), // "downloaded"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 15), // "imageDownloaded"
QT_MOC_LITERAL(4, 44, 14), // "QNetworkReply*"
QT_MOC_LITERAL(5, 59, 6) // "pReply"

    },
    "imageDownloader\0downloaded\0\0imageDownloaded\0"
...
void imageDownloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->imageDownloaded((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&imageDownloader::downloaded)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject imageDownloader::staticMetaObject = { {
    ...
    qt_meta_stringdata_imageDownloader.data,
...
// SIGNAL 0
void imageDownloader::downloaded()
{
